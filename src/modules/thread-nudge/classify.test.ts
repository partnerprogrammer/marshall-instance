...
const { collectCandidates, findRelatedThread, getThreadOpener, significantKeywords, isAnnouncement } =
...
describe('isAnnouncement', () => {
  ...
  it('matches a release header preceded by a celebration line — real corpus shape', () => {
    expect(
      isAnnouncement('The first step to Hubspot! Thank you @U0KAIO00001!\nRelease 1.1.0\nThe Hub Help Desk Is Here'),
    ).toBe(true);
  });
