...
import { maybeRotateProviderContinuation, runProviderBeforeCompact } from '../provider-contracts/realize.js';
...
// functions the verifier probes exercise.
import {
...
registerProvider('claude', { create: (opts) => new ClaudeProvider(opts), contract: claudeRuntimeContract });
