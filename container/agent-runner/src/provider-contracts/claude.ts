...
import {
  ...
  type RuntimeContinuationRotationInput,
...
export const claudeRuntimeContract: ProviderRuntimeContract = {
  ...
  configuration: {
    ...
    executionPolicy: { value: resolveClaudeExecutionPolicy(undefined, process.env) },
    inference: { resolve: resolveClaudeInference },
    memory: { resolve: resolveClaudeMemoryRuntime },
    mcpServers: { resolve: resolveClaudeMcpServers },
  },
  lifecycle: { memorySessionHookRegistration: writeMemorySessionHook },
  history: {
    beforeCompact: archiveClaudeTranscript,
    rotateContinuation: rotateClaudeContinuation,
    readTrace: newestClaudeTranscript,
  },
...
function archiveClaudeTranscript(input: RuntimeBeforeCompactInput, fx: RuntimeCallbackEffects): boolean {
...
function rotateClaudeContinuation(input: RuntimeContinuationRotationInput, fx: RuntimeCallbackEffects): string | null {
